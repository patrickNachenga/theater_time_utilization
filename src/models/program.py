...
class Program(BaseModel):
    ...
    current_program_student_program_changes = relationship("StudentProgramChange", lazy='subquery', back_populates="current_program")
    new_program_student_program_changes = relationship("StudentProgramChange", lazy='subquery', back_populates="new_program")