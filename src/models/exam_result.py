...
class ExamResult(BaseModel):
    ...
    program_course = relationship("ProgramCourse", lazy="noload", back_populates="exam_results")

    exam_category = relationship("ExamCategory", lazy="noload", back_populates="exam_results")
