...
class AcademicYear(BaseModel):
    ...
    # program_semesters = relationship('ProgramSemester', lazy='subquery')
    # program_capacities = relationship('ProgramCapacity', lazy='subquery')
    # academic_year_semesters = relationship('AcademicYearSemester', lazy='subquery')
    # student_program_changes = relationship('StudentProgramChange', lazy='subquery')
