...
class Course(BaseModel):
    ...
    # ---------------Referenced Columns ---------------------
    program_courses = relationship('ProgramCourse', lazy='noload', back_populates="course")
    course_learn_outcomes = relationship("CourseLearnOutcome", lazy="noload", back_populates="course")