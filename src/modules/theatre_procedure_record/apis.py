...
class TheatreTimeRecordQuery:
    ...
    def get_theatre_time_records(self, pagination: PaginationInput) -> Response[TheatreTimeRecordListNode]:
        try:
            result = TheatreTimeRecordCrud.get_multi_paginated(pagination, ['patient_mrn', 'patient_type'],
                                                               TheatreTimeRecordListNode, [
                                                                   TheatreProcedureRecord.patient_region, TheatreProcedureRecord.procedure,
                                                                   TheatreProcedureRecord.theatre_unit, TheatreProcedureRecord.team_members, TheatreProcedureRecord.team_members.theate_member])
