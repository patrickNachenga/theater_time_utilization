...
class StudentMutation:
    ...
    def generate_allocation_xls_template(self, allocation_uid: str, out_off: int, exam_category_id: int,
        ...
        worksheet.cell(row=2, column=4, value=str(result["program_course"].course.code))
        worksheet.cell(row=2, column=4).font = font_border
        ...
        for row in exam_cat_result:
            ...
            worksheet.cell(row=2, column=5, value=str(exam_cat_name + ": " + assessment_number))
