...
# scheduler.add_job(create_course_to_moodle, 'interval', seconds=20)
# scheduler.add_job(create_group_to_moodle, 'interval', seconds=25)
#
# scheduler.add_job(enroll_staff_to_moodle_course, 'interval', seconds=10)
# scheduler.add_job(enroll_student_to_moodle_course, 'interval', seconds=35)
#
