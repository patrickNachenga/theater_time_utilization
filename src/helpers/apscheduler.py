...
scheduler.add_job(create_group_to_moodle, 'interval', seconds=15)

scheduler.add_job(enroll_staff_to_moodle_course, 'interval', seconds=15)
scheduler.add_job(enroll_student_to_moodle_course, 'interval', seconds=15)

scheduler.add_job(enroll_student_to_moodle_group, 'interval', seconds=20)
scheduler.add_job(enroll_staff_to_moodle_group, 'interval', seconds=20)
